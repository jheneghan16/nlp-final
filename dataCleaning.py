...
our_data = pd.DataFrame({'Tweet':tweet_list,'Outcome':outcome_list, 'Spread_Outcome':spread_outcome_list})
our_data.to_csv('Spread_Outcomes.csv',index = None, header = ['Tweet','Outcome','Spread_Outcome'])